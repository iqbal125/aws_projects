...
export interface GetItemLambdaProps {
    cluster: rds.DatabaseCluster;
    secret: secretsmanager.Secret;

}

export class GetItemLambda extends Construct {
    public readonly function: lambdaNodejs.NodejsFunction;
    public readonly alias: lambda.Alias;

    constructor(scope: Construct, id: string, props: GetItemLambdaProps) {
        super(scope, id);

        this.function = new lambdaNodejs.NodejsFunction(this, 'GetItemFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            entry: path.join(__dirname, 'handler.ts'),
            timeout: cdk.Duration.seconds(30),
            memorySize: 256,
            description: 'Get single item Lambda function',
            bundling: {
                externalModules: [],
            },
            environment: {
        ...
        this.alias = new lambda.Alias(this, 'GetItemAlias', {
            aliasName: 'live',
            version: this.function.currentVersion,
            description: 'Live alias for GetItem function'
        });
